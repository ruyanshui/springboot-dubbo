...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    public List<OrderEntity> findOrdersForBuyer(OrderQueryReq orderQueryReq, String buyerId) {
        // 参数校验
    ...
    @Override
    public List<OrderEntity> findOrdersForSeller(OrderQueryReq orderQueryReq, String sellerId) {
        // 参数校验
        checkParam(orderQueryReq, ExpCodeEnum.ORDERQUERYREQ_NULL);
    ...
    @Override
    public List<OrderEntity> findOrdersForAdmin(OrderQueryReq orderQueryReq) {
        // 参数校验
        checkParam(orderQueryReq, ExpCodeEnum.ORDERQUERYREQ_NULL);
