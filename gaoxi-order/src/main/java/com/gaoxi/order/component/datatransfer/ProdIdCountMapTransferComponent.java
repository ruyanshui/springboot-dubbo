...
public class ProdIdCountMapTransferComponent extends BaseDataTransferComponent{
    ...
    protected void transfer(OrderProcessContext orderProcessContext) {
        ...
        // 查询该笔订单
        OrderEntity ordersEntity = query(orderQueryReq);
     ...
     * @return 订单结果
     */
    private OrderEntity query(OrderQueryReq orderQueryReq) {
     ...
     */
    private Map<String, Integer> buildProdIdCountMap(OrderEntity ordersEntity) {
        // 初始化结果集
