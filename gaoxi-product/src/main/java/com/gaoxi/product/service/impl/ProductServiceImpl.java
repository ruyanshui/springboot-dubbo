package com.gaoxi.product.service.impl;
...
import com.gaoxi.product.dao.IBrandDAO;
import com.gaoxi.product.dao.ICategoryDAO;
import com.gaoxi.product.dao.IProductDAO;
...
public class ProductServiceImpl implements IProductorService{
    ...
    private void checkBrandParam(BrandInsertReq brandInsertReq) {
